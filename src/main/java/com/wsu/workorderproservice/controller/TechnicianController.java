...
public class TechnicianController {
    ...
    @GetMapping
    public ResponseEntity<ServiceResponseDTO> getAllTechnicians(@RequestParam(required = false, name = "search") String search,
                                                                @RequestParam(required = false, defaultValue = "1", name = "page") Integer page,
                                                                @RequestParam(required = false, defaultValue = "10", name = "rpp") Integer rpp,
                                                                @RequestParam(required = false, defaultValue = "technicianCode", name = "sortField") String sortField,
                                                                @RequestParam(required = false, defaultValue = Constants.DESC, name = "sortOrder") String sortOrder) {
        Page<TechnicianDTO> technicianDTOPage = technicianService.getAllTechnicians(search, sortField, sortOrder, page, rpp);
